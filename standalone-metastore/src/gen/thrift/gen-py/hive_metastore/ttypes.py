      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i515 in xrange(_size511):
            ...
            self.srcTxnIds.append(_elem516)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
...
class GetTargetTxnIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i522 in xrange(_size518):
            ...
            self.targetTxnIds.append(_elem523)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.targetTxnIds is not None:
      ...
      for iter524 in self.targetTxnIds:
...
class GetValidWriteIdsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i529 in xrange(_size525):
            ...
            self.fullTableNames.append(_elem530)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fullTableNames is not None:
      ...
      for iter531 in self.fullTableNames:
        oprot.writeString(iter531)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TableValidWriteIds:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i536 in xrange(_size532):
            ...
            self.invalidWriteIds.append(_elem537)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.invalidWriteIds is not None:
      ...
      for iter538 in self.invalidWriteIds:
...
class GetValidWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i543 in xrange(_size539):
            _elem544 = TableValidWriteIds()
            _elem544.read(iprot)
            self.tblValidWriteIds.append(_elem544)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tblValidWriteIds is not None:
      ...
      for iter545 in self.tblValidWriteIds:
        iter545.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AllocateTableWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i557 in xrange(_size553):
            _elem558 = TxnToWriteId()
            _elem558.read(iprot)
            self.txnToWriteIds.append(_elem558)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.txnToWriteIds is not None:
      ...
      for iter559 in self.txnToWriteIds:
        iter559.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i564 in xrange(_size560):
            _elem565 = LockComponent()
            _elem565.read(iprot)
            self.component.append(_elem565)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i571 in xrange(_size567):
            _elem572 = ShowLocksResponseElement()
            _elem572.read(iprot)
            self.locks.append(_elem572)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.SET:
          self.aborted = set()
          (_etype577, _size574) = iprot.readSetBegin()
          for _i578 in xrange(_size574):
            _elem579 = iprot.readI64()
            self.aborted.add(_elem579)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i592 in xrange(_size588):
            ...
            self.properties[_key593] = _val594
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter595,viter596 in self.properties.items():
        oprot.writeString(kiter595)
        oprot.writeString(viter596)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i601 in xrange(_size597):
            _elem602 = ShowCompactResponseElement()
            _elem602.read(iprot)
            self.compacts.append(_elem602)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i608 in xrange(_size604):
            ...
            self.partitionnames.append(_elem609)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter610 in self.partitionnames:
...
class CreationMetadata:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          self.tablesUsed = set()
          (_etype614, _size611) = iprot.readSetBegin()
          for _i615 in xrange(_size611):
            _elem616 = iprot.readString()
            self.tablesUsed.add(_elem616)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter617 in self.tablesUsed:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i622 in xrange(_size618):
            _elem623 = NotificationEvent()
            _elem623.read(iprot)
            self.events.append(_elem623)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i629 in xrange(_size625):
            ...
            self.filesAdded.append(_elem630)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i635 in xrange(_size631):
            ...
            self.filesAddedChecksum.append(_elem636)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter637 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter638 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i643 in xrange(_size639):
            ...
            self.partitionVals.append(_elem644)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter645 in self.partitionVals:
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter669,viter670 in self.metadata.items():
...
class ClearFileMetadataRequest:
  ...
  def write(self, oprot):
    ...
    if self.fileIds is not None:
      oprot.writeFieldBegin('fileIds', TType.LIST, 1)
      oprot.writeListBegin(TType.I64, len(self.fileIds))
      for iter698 in self.fileIds:
        oprot.writeI64(iter698)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i703 in xrange(_size699):
            _elem704 = Function()
            _elem704.read(iprot)
            self.functions.append(_elem704)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Materialization:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      oprot.writeSetBegin(TType.STRING, len(self.tablesUsed))
      for iter733 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i756 in xrange(_size752):
            _elem757 = WMPoolTrigger()
            _elem757.read(iprot)
            self.poolTriggers.append(_elem757)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter761 in self.poolTriggers:
        iter761.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i766 in xrange(_size762):
            _elem767 = WMResourcePlan()
            _elem767.read(iprot)
            self.resourcePlans.append(_elem767)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter768 in self.resourcePlans:
        iter768.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
