  ...
  private static class PutFileMetadataRequestTupleScheme extends TupleScheme<PutFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (ByteBuffer _iter883 : struct.metadata)
        {
          oprot.writeBinary(_iter883);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list884 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.fileIds = new ArrayList<Long>(_list884.size);
        long _elem885;
        for (int _i886 = 0; _i886 < _list884.size; ++_i886)
        {
          _elem885 = iprot.readI64();
          struct.fileIds.add(_elem885);
        }
      }
      struct.setFileIdsIsSet(true);
      {
        ...
        struct.metadata = new ArrayList<ByteBuffer>(_list887.size);
        ByteBuffer _elem888;
        for (int _i889 = 0; _i889 < _list887.size; ++_i889)
        {
          _elem888 = iprot.readBinary();
          struct.metadata.add(_elem888);
        }
      }
      struct.setMetadataIsSet(true);
