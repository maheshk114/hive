            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileIds = new ArrayList<Long>(_list890.size);
                long _elem891;
                for (int _i892 = 0; _i892 < _list890.size; ++_i892)
                {
                  _elem891 = iprot.readI64();
                  struct.fileIds.add(_elem891);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClearFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.fileIds != null) {
        oprot.writeFieldBegin(FILE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter893 : struct.fileIds)
          {
            oprot.writeI64(_iter893);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ClearFileMetadataRequestTupleScheme extends TupleScheme<ClearFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClearFileMetadataRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (long _iter894 : struct.fileIds)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClearFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list895 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.fileIds = new ArrayList<Long>(_list895.size);
        long _elem896;
        for (int _i897 = 0; _i897 < _list895.size; ++_i897)
        {
          _elem896 = iprot.readI64();
          struct.fileIds.add(_elem896);
        }
      }
      struct.setFileIdsIsSet(true);
    }
