            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<String>(_list978.size);
                String _elem979;
                for (int _i980 = 0; _i980 < _list978.size; ++_i980)
                {
                  _elem979 = iprot.readString();
                  struct.errors.add(_elem979);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.warnings = new ArrayList<String>(_list981.size);
                String _elem982;
                for (int _i983 = 0; _i983 < _list981.size; ++_i983)
                {
                  _elem982 = iprot.readString();
                  struct.warnings.add(_elem982);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.errors != null) {
        if (struct.isSetErrors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (String _iter984 : struct.errors)
            {
      ...
      if (struct.warnings != null) {
        if (struct.isSetWarnings()) {
          oprot.writeFieldBegin(WARNINGS_FIELD_DESC);
          {
            ...
            for (String _iter985 : struct.warnings)
            {
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (String _iter986 : struct.errors)
          {
      ...
      if (struct.isSetWarnings()) {
        {
          ...
          for (String _iter987 : struct.warnings)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.errors = new ArrayList<String>(_list988.size);
          String _elem989;
          for (int _i990 = 0; _i990 < _list988.size; ++_i990)
          {
            _elem989 = iprot.readString();
            struct.errors.add(_elem989);
          }
        }
        struct.setErrorsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.warnings = new ArrayList<String>(_list991.size);
          String _elem992;
          for (int _i993 = 0; _i993 < _list991.size; ++_i993)
          {
            _elem992 = iprot.readString();
            struct.warnings.add(_elem992);
          }
        }
        struct.setWarningsIsSet(true);
      }
