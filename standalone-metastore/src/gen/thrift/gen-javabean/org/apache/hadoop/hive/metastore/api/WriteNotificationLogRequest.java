            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new ArrayList<String>(_list830.size);
                String _elem831;
                for (int _i832 = 0; _i832 < _list830.size; ++_i832)
                {
                  _elem831 = iprot.readString();
                  struct.partitionVals.add(_elem831);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (String _iter833 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (String _iter834 : struct.partitionVals)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionVals = new ArrayList<String>(_list835.size);
          String _elem836;
          for (int _i837 = 0; _i837 < _list835.size; ++_i837)
          {
            _elem836 = iprot.readString();
            struct.partitionVals.add(_elem836);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
