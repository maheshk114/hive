            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new ArrayList<ClientCapability>(_list906.size);
                ClientCapability _elem907;
                for (int _i908 = 0; _i908 < _list906.size; ++_i908)
                {
                  _elem907 = org.apache.hadoop.hive.metastore.api.ClientCapability.findByValue(iprot.readI32());
                  struct.values.add(_elem907);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientCapabilities struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (ClientCapability _iter909 : struct.values)
          {
  ...
  private static class ClientCapabilitiesTupleScheme extends TupleScheme<ClientCapabilities> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClientCapabilities struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ClientCapability _iter910 : struct.values)
        {
          oprot.writeI32(_iter910.getValue());
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClientCapabilities struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list911 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.values = new ArrayList<ClientCapability>(_list911.size);
        ClientCapability _elem912;
        for (int _i913 = 0; _i913 < _list911.size; ++_i913)
        {
          _elem912 = org.apache.hadoop.hive.metastore.api.ClientCapability.findByValue(iprot.readI32());
          struct.values.add(_elem912);
        }
      }
      struct.setValuesIsSet(true);
    }
