            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resourcePlans = new ArrayList<WMResourcePlan>(_list970.size);
                WMResourcePlan _elem971;
                for (int _i972 = 0; _i972 < _list970.size; ++_i972)
                {
                  _elem971 = new WMResourcePlan();
                  _elem971.read(iprot);
                  struct.resourcePlans.add(_elem971);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.resourcePlans != null) {
        if (struct.isSetResourcePlans()) {
          oprot.writeFieldBegin(RESOURCE_PLANS_FIELD_DESC);
          {
            ...
            for (WMResourcePlan _iter973 : struct.resourcePlans)
            {
      ...
      if (struct.isSetResourcePlans()) {
        {
          ...
          for (WMResourcePlan _iter974 : struct.resourcePlans)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resourcePlans = new ArrayList<WMResourcePlan>(_list975.size);
          WMResourcePlan _elem976;
          for (int _i977 = 0; _i977 < _list975.size; ++_i977)
          {
            _elem976 = new WMResourcePlan();
            _elem976.read(iprot);
            struct.resourcePlans.add(_elem976);
          }
        }
        struct.setResourcePlansIsSet(true);
      }
