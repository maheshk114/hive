            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.compacts = new ArrayList<ShowCompactResponseElement>(_list766.size);
                ShowCompactResponseElement _elem767;
                for (int _i768 = 0; _i768 < _list766.size; ++_i768)
                {
                  _elem767 = new ShowCompactResponseElement();
                  _elem767.read(iprot);
                  struct.compacts.add(_elem767);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.compacts != null) {
        oprot.writeFieldBegin(COMPACTS_FIELD_DESC);
        {
          ...
          for (ShowCompactResponseElement _iter769 : struct.compacts)
          {
  ...
  private static class ShowCompactResponseTupleScheme extends TupleScheme<ShowCompactResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ShowCompactResponseElement _iter770 : struct.compacts)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.compacts = new ArrayList<ShowCompactResponseElement>(_list771.size);
        ShowCompactResponseElement _elem772;
        for (int _i773 = 0; _i773 < _list771.size; ++_i773)
        {
          _elem772 = new ShowCompactResponseElement();
          _elem772.read(iprot);
          struct.compacts.add(_elem772);
        }
      }
      struct.setCompactsIsSet(true);
    }
