...
--  CTC_ID NUMBER(10) GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
--  CTC_TIMESTAMP timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL
) ROWDEPENDENCIES;

--CREATE INDEX COMPLETED_TXN_COMPONENTS_INDEX ON COMPLETED_TXN_COMPONENTS (CTC_ID);
CREATE INDEX COMPLETED_TXN_COMPONENTS_IDEX2 ON COMPLETED_TXN_COMPONENTS (CTC_DATABASE, CTC_TABLE, CTC_PARTITION);
