...
public class OpenTxnTask extends Task<OpenTxnWork> {
  ...
  public int execute(DriverContext driverContext) {
    ...
    try {
      /*long txnId = driverContext.getCtx().getHiveTxnManager().openTxn(
              driverContext.getCtx(), work.getUser(), 0, work.getDbName());
      driverContext.getCtx().getHiveTxnManager().updateTxnMap(work.getTxnId(), txnId);*/
      return 0;
    } catch (Exception e) {
