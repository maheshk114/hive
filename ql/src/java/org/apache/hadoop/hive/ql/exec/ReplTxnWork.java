...
public class ReplTxnWork implements Serializable {
  ...
  private List<Long> txnIds, writeIdList;
  private List<String> dbList, tableList, partitionList;
  ...
  public void addCommitTxnInfo(String db, String table, String partition, Long writeId) {
    this.dbList.add(db);
    this.tableList.add(table);
    this.partitionList.add(partition);
    this.writeIdList.add(writeId);
  }
  ...
  public List<Long> getWriteIdList() {
    return writeIdList;
  }
}
