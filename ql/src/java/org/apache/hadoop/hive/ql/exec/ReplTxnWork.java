...
public class ReplTxnWork implements Serializable {
  ...
  public enum OperationType {
    ...
    REPL_ALLOC_WRITE_ID("REPL_ALLOC_WRITE_ID");
  ...
  public ReplTxnWork(String dbName, String tableName, List<Long> txnIdsItr, OperationType type) {
  ...
  public List<Long> getTxnIdsList() {
    return txnIds;
  }
