    ...
    try {
      ...
      switch(work.getOperationType()) {
        ...
        case REPL_COMMIT_TXN:
          CommitTxnRequest commitTxnRequest = new CommitTxnRequest(work.getTxnId(0));
          commitTxnRequest.setReplPolicy(work.getReplPolicy());
          commitTxnRequest.setWriteIds(work.getWriteIdList());
          commitTxnRequest.setPartitions(work.getPartitionList());
          commitTxnRequest.setDatabases(work.getDbList());
